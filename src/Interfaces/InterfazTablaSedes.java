...
import Controladores.CntrlTablaSedes;
import Datos.BD;

public class InterfazTablaSedes extends JFrame{
	...
	public InterfazTablaSedes(String string) {
		super(string);		
	...
	public void controlador (CntrlTablaSedes c) {
		removeButton.addActionListener(c);
		removeButton.setActionCommand(BORRAR);
